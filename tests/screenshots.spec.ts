...
test.describe("PWA Screenshots", () => {
	test("capture desktop screenshot", async ({ browser }) => {
		...
		try {
			...
			console.log("✅ Desktop screenshot saved: public/screenshots/desktop-1.png");
		} catch (error) {
	...
	test("capture mobile screenshot", async ({ browser }) => {
		...
		try {
			...
			console.log("✅ Mobile screenshot saved: public/screenshots/mobile-1.png");
		} catch (error) {
	...
	test("capture desktop screenshot with active day", async ({ browser }) => {
		...
		try {
			...
			try {
				const startButton = page.locator("button:has-text('Start Day')").first();
			...
			console.log("✅ Desktop active screenshot saved: public/screenshots/desktop-2-active.png");
		} catch (error) {
	...
	test("capture mobile screenshot with bottom nav", async ({ browser }) => {
		...
		try {
			...
			console.log("✅ Mobile nav screenshot saved: public/screenshots/mobile-2-nav.png");
		} catch (error) {
