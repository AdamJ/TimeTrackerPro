...
| `src/hooks/useKeyboardShortcuts.ts`           | Global web/PWA `keydown` listener: `Cmd/Ctrl+N` new task, `Cmd/Ctrl+S` save, `Cmd/Ctrl+K` command palette, `?` shortcuts help; ignores typing targets except save/palette |
