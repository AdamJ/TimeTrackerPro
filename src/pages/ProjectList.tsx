...
const ProjectContent: React.FC = () => {
  ...
  const openResetDialog = useCallback(() => setShowResetDialog(true), []);
  const pageTitle = useMemo(() => <>Projects</>, []);
  ...
  const pageActions = useMemo(
    () => (
      <div className="flex space-x-2">
        <Button onClick={openResetDialog} size="sm" variant="outline">
            ...
            <div className="space-y-4">
              ...
              {showArchived && (
                <div className="grid gap-4">
                  ...
                  <div key={project.id} className="flex w-full flex-col gap-4">
                    <Item
                      variant="outline"
                      className="bg-muted"
                      >
